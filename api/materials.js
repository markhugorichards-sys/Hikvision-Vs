 ...
 *                                        category, sector, productKey }  (upload)
...
function publicEntry(m) {
  return {
    ...
    category: m.category, sector: m.sector, productKey: m.productKey,
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    if (req.method === 'POST') {
      ...
      const { filename, mime, dataBase64, type, category, sector, productKey } = body || {};
